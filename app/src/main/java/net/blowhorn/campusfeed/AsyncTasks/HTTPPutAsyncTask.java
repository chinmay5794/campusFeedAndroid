...
public class HTTPPutAsyncTask extends AsyncTask<String,String,String> {

    private String TAG = "HTTPPut";
    ...
    public HTTPPutAsyncTask(Context context, boolean setLoader){
